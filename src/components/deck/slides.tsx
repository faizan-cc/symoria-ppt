...
export function Slide02Problem({ isActive }: SlideComponentProps) {
  return (
    <section data-slide-idx={2} className={slideClassName(isActive)} id="s2" style={{ alignItems: "flex-start" }}>
      ...
      <div className="stat-95" data-split-chars>
        95%
      </div>
      ...
      <div className="sub" style={{ marginTop: 20 }}>
        Emotion, timing errors, and information asymmetry cost retail traders billions. The market doesn&apos;t forgive hesitation.
      </div>
    </section>
  );
}
